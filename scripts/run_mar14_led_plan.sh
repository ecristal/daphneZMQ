...
VD_BIAS_AFE0_DAC="${VD_BIAS_AFE0_DAC:-1226}"
VD_BIAS_AFE1_DAC="${VD_BIAS_AFE1_DAC:-857}"
...
mar14_vd() {
  configure_fe "$VGAIN" "$OFFSET" "$VD_BIAS_AFE0_DAC" "$VD_BIAS_AFE1_DAC"
  run_scan \
    client/dynamic_range_led/runs/led_intensity_mask1_270nm_0700_0900_L1024_15k_vgain500_off2200_afe0p1V_vd_mar14 \
    4,5,6,7 \
    700 \
    900 \
    20
...
mar14_vd_resume() {
  configure_fe "$VGAIN" "$OFFSET" "$VD_BIAS_AFE0_DAC" "$VD_BIAS_AFE1_DAC"
  run_scan \
    client/dynamic_range_led/runs/led_intensity_mask1_270nm_0800_0900_L1024_15k_vgain500_off2200_afe0p1V_vd_mar14_resume1 \
    4,5,6,7 \
    800 \
    900 \
    20
...
mar14_hd_ch12() {
  ...
  run_scan \
    client/dynamic_range_led/runs/led_intensity_mask1_270nm_1100_1150_L1024_15k_vgain500_off2200_ch12_mar14 \
    12 \
    1100 \
    1150 \
    20
...
mar14_hd_ch13() {
  configure_fe "$VGAIN" "$OFFSET" "$HD_BIAS_AFE0_DAC" "$HD_BIAS_AFE1_DAC"
  run_scan \
    client/dynamic_range_led/runs/led_intensity_mask1_270nm_1150_1250_L1024_15k_vgain500_off2200_ch13_mar14 \
    13 \
    1150 \
    1250 \
    20
...
mar14_hd_ch14() {
  configure_fe "$VGAIN" "$OFFSET" "$HD_BIAS_AFE0_DAC" "$HD_BIAS_AFE1_DAC"
  run_scan \
    client/dynamic_range_led/runs/led_intensity_mask1_270nm_1200_1250_L1024_15k_vgain500_off2200_ch14_mar14 \
    14 \
    1200 \
    1250 \
    20
...
mar14_hd_ch15() {
  configure_fe "$VGAIN" "$OFFSET" "$HD_BIAS_AFE0_DAC" "$HD_BIAS_AFE1_DAC"
  run_scan \
    client/dynamic_range_led/runs/led_intensity_mask1_270nm_1200_1250_L1024_15k_vgain500_off2200_ch15_mar14 \
    15 \
    1200 \
    1250 \
    20
...
Environment overrides:
  ...
  VD_BIAS_AFE0_DAC=1226
  VD_BIAS_AFE1_DAC=857
...
main() {
  ...
  case "$target" in
    mar14_vd) mar14_vd ;;
    mar14_vd_resume) mar14_vd_resume ;;
    mar14_hd_ch12) mar14_hd_ch12 ;;
    mar14_hd_ch13) mar14_hd_ch13 ;;
    mar14_hd_ch14) mar14_hd_ch14 ;;
    mar14_hd_ch15) mar14_hd_ch15 ;;
    all)
      mar14_vd
      mar14_hd_ch12
      mar14_hd_ch13
